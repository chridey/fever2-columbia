...
class MyTextField(SequenceField[Dict[str, torch.Tensor]]):
    """
    ...
    """
    def __init__(self, tokens: List[Token], token_indexers: Dict[str, TokenIndexer], metadata=None) -> None:
        self.tokens = tokens
    ...
    def __str__(self) -> str:
        ...
        if self._metadata is not None:
            return f"TextField of length {self.sequence_length()} with " \
               f"text: \n {formatted_text} \t\tand TokenIndexers : {indexers} and Metadata: {self._metadata}"
